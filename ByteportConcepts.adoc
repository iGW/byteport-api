...
The steps to take to get started with Byteport boils down to
...
the *security* tab, add a user by typing in the Byteport username or email of the user you wish to add.
...
.7a) Connect a device to Byteport
...
image:byteport_core_model.svg["The core concepts/classes of Byteport",width=600]
