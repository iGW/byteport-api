...
- Can not contain other characters than: 0-9, a-z and A-Z dashes and underscores.

In addition, a namespace created by a user most be longer than 6 characters.
